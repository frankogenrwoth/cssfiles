...
function listener(e, t) {
    e.onkeyup = function() {
        let n = [],
            o = e.value,
            i = e.value;
        " " === i.charAt(i.length - 1) && updateSuggestions(i, t), o.length && (n = suggestions.filter((e => e.toLowerCase().includes(o.toLowerCase())))), display(n, e, t), console.log(n), n.length ? t.style = "display: block;" : t.style = "display: none;"
    }
}
...
var data = fetch("https://www.chordmp3.com/search01294.json")
